(function () {
  ...
  style.textContent = [
    ...
    ".project-password-input-row { display: grid; grid-template-columns: 38px 1fr auto 42px; align-items: center; min-height: 48px; padding: 4px 6px 4px 14px; gap: 8px; background: #fff; border: 1px solid #e4e4e4; border-radius: 999px; box-shadow: 0 2px 12px rgba(17, 17, 17, 0.08); }",
    ...
    "html.project-password-pending .project-password-input-row { display: grid !important; grid-template-columns: 38px 1fr auto 42px !important; align-items: center !important; min-height: 48px !important; padding: 4px 6px 4px 14px !important; gap: 8px !important; background: #fff !important; border: 1px solid #e4e4e4 !important; border-radius: 999px !important; }",
