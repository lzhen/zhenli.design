(function () {
  ...
  style.textContent = [
    ...
    "html.project-password-pending .project-password-input-row { display: grid !important; grid-template-columns: 1fr 50px !important; min-height: 42px !important; background: #fff !important; border: 1px solid #b8b8b8 !important; border-radius: 8px !important; overflow: hidden !important; }",
    "html.project-password-pending .project-password-form input { width: 100% !important; min-width: 0 !important; border: 0 !important; padding: 0 14px !important; background: transparent !important; color: #1d1d1f !important; font-size: 13px !important; }",
    ...
    "@media (max-width: 560px) { .project-password-gate { padding: 22px; } .project-password-panel h1, html.project-password-pending .project-password-panel h1 { font-size: 14px !important; } .project-password-note { margin-bottom: 38px; font-size: 14px; } .project-password-form { width: 100%; } }"
  ].join("\n");
