(function () {
  ...
  style.textContent = [
    ...
    ".project-password-form { width: min(100%, 320px); display: grid; gap: 12px; }",
    ...
    ".project-password-input-row { display: grid; grid-template-columns: 1fr 44px; min-height: 40px; background: #fff; border: 1px solid #b8b8b8; border-radius: 999px; overflow: hidden; box-shadow: 0 8px 22px rgba(17, 17, 17, 0.05); }",
    ".project-password-form input { width: 100%; min-width: 0; border: 0; border-radius: 0; padding: 0 13px; background: transparent; color: #1d1d1f; font: inherit; font-size: 13px; line-height: 1.2; }",
    ...
    "html.project-password-pending .project-password-form { width: min(100%, 320px) !important; display: grid !important; gap: 12px !important; }",
    ...
    "html.project-password-pending .project-password-input-row { display: grid !important; grid-template-columns: 1fr 44px !important; min-height: 40px !important; background: #fff !important; border: 1px solid #b8b8b8 !important; border-radius: 999px !important; overflow: hidden !important; }",
    "html.project-password-pending .project-password-form input { width: 100% !important; min-width: 0 !important; border: 0 !important; padding: 0 13px !important; background: transparent !important; color: #1d1d1f !important; font-size: 13px !important; }",
