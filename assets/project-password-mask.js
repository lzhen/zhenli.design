(function () {
  ...
  style.textContent = [
    ...
    ".project-password-panel h1 { margin: 0; color: #111; font-family: var(--font-label, Arial, Helvetica, ui-sans-serif, system-ui, sans-serif); font-size: clamp(14px, 2.1vw, 24px); line-height: 1.4; font-weight: 700; letter-spacing: 2px; text-transform: uppercase; }",
    ...
    "html.project-password-pending .project-password-panel h1 { margin: 0 !important; color: #111 !important; font-family: var(--font-label, Arial, Helvetica, ui-sans-serif, system-ui, sans-serif) !important; font-size: clamp(14px, 2.1vw, 24px) !important; line-height: 1.4 !important; font-weight: 700 !important; letter-spacing: 2px !important; text-transform: uppercase !important; }",
