(function () {
  ...
  style.textContent = [
    ...
    ".project-password-logo { display: block; width: 34px; height: auto; transform: translateY(-18px); }",
    ".project-password-panel h1 { margin: -18px 0 0; color: #111; font-family: var(--font-label, Arial, Helvetica, ui-sans-serif, system-ui, sans-serif); font-size: clamp(14px, 2.1vw, 18px); line-height: 1.4; font-weight: 700; letter-spacing: 2px; text-transform: uppercase; }",
    ...
    ".project-password-input-row { display: grid; grid-template-columns: 1fr 42px; align-items: center; min-height: 48px; padding: 4px 6px 4px 20px; gap: 8px; background: #fff; border: 1px solid #f2f2f2; border-radius: 999px; box-shadow: 0 2px 8px rgba(0, 0, 0, 0.035); }",
    ...
    ".project-password-form input::placeholder { color: rgba(29, 29, 31, 0.34); font-size: 14px; }",
    ...
    "html.project-password-pending .project-password-logo { transform: translateY(-18px) !important; }",
    "html.project-password-pending .project-password-panel h1 { margin: -18px 0 0 !important; color: #111 !important; font-family: var(--font-label, Arial, Helvetica, ui-sans-serif, system-ui, sans-serif) !important; font-size: clamp(14px, 2.1vw, 18px) !important; line-height: 1.4 !important; font-weight: 700 !important; letter-spacing: 2px !important; text-transform: uppercase !important; }",
    "html.project-password-pending .project-password-form { width: min(100%, 360px) !important; display: grid !important; gap: 12px !important; }",
    "html.project-password-pending .project-password-input-row { display: grid !important; grid-template-columns: 1fr 42px !important; align-items: center !important; min-height: 48px !important; padding: 4px 6px 4px 20px !important; gap: 8px !important; background: #fff !important; border: 1px solid #f2f2f2 !important; border-radius: 999px !important; box-shadow: 0 2px 8px rgba(0, 0, 0, 0.035) !important; }",
    ...
    "html.project-password-pending .project-password-form input::placeholder { color: rgba(29, 29, 31, 0.34) !important; font-size: 14px !important; }",
