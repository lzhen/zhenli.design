(function () {
  ...
  style.textContent = [
    ...
    ".project-password-note { margin: -4px 0 48px; color: rgba(247, 247, 247, 0.58); font-size: 15px; line-height: 1.5; font-weight: 300; }",
    ...
    ".project-password-input-row { display: grid; grid-template-columns: 1fr 58px; min-height: 48px; background: rgba(255, 255, 255, 0.96); border: 1px solid rgba(255, 255, 255, 0.52); }",
    ...
    "html.project-password-pending .project-password-input-row { display: grid !important; grid-template-columns: 1fr 58px !important; min-height: 48px !important; background: rgba(255, 255, 255, 0.96) !important; }",
