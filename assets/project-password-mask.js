(function () {
  ...
  style.textContent = [
    ...
    "html.project-password-pending .project-password-panel h1 { margin: 0 !important; color: #111 !important; font-family: var(--font-label, Arial, Helvetica, ui-sans-serif, system-ui, sans-serif) !important; font-size: clamp(18px, 2.1vw, 24px) !important; line-height: 1.4 !important; font-weight: 700 !important; letter-spacing: 2px !important; text-transform: uppercase !important; }",
    ...
    "@media (max-width: 560px) { .project-password-gate { padding: 22px; } .project-password-panel h1, html.project-password-pending .project-password-panel h1 { font-size: 18px !important; } .project-password-note { margin-bottom: 38px; font-size: 14px; } .project-password-form { width: 100%; } }"
  ].join("\n");
