(function () {
  ...
  style.textContent = [
    ...
    ".project-password-input-row { display: grid; grid-template-columns: 1fr 44px; min-height: 40px; background: #fff; border: 1px solid #b8b8b8; border-radius: 10px; overflow: hidden; box-shadow: 0 8px 22px rgba(17, 17, 17, 0.05); }",
    ...
    "html.project-password-pending .project-password-input-row { display: grid !important; grid-template-columns: 1fr 44px !important; min-height: 40px !important; background: #fff !important; border: 1px solid #b8b8b8 !important; border-radius: 10px !important; overflow: hidden !important; }",
