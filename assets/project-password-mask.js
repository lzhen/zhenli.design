(function () {
  ...
  style.textContent = [
    ...
    ".project-password-input-row { display: grid; grid-template-columns: 1fr 42px; align-items: center; min-height: 48px; padding: 4px 6px 4px 20px; gap: 8px; background: #fff; border: 1px solid #eeeeee; border-radius: 999px; box-shadow: 0 4px 14px rgba(0, 0, 0, 0.055); }",
    ...
    "html.project-password-pending .project-password-input-row { display: grid !important; grid-template-columns: 1fr 42px !important; align-items: center !important; min-height: 48px !important; padding: 4px 6px 4px 20px !important; gap: 8px !important; background: #fff !important; border: 1px solid #eeeeee !important; border-radius: 999px !important; box-shadow: 0 4px 14px rgba(0, 0, 0, 0.055) !important; }",
